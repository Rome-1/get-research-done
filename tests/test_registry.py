...
class TestParseCommandFile:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("description: true", r"description for grd:help must be a string"),
            ("argument-hint: 5", r"argument-hint for grd:help must be a string"),
        ],
    )
    ...
    def test_command_review_contract_review_mode_rejects_unsupported_value(self, tmp_path: Path) -> None:
        ...
        f.write_text(
            "---\n"
            "name: grd:review-mode-unsupported\n"
            "review-contract:\n"
            "  review_mode: draft\n"
            "---\n"
            "Body.",
    ...
    def test_command_review_contract_requires_explicit_schema_version(self, tmp_path: Path) -> None:
        ...
        f.write_text(
            "---\n"
            "name: grd:missing-schema-version\n"
            "review-contract:\n"
            "  review_mode: publication\n"
            "---\n"
            "Body.",
