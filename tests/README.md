...
Generated on `2026-03-28` from the current worktree.
...
- Live repo files analyzed in the current tree: `702`
- Python files under `src/` and `tests/`: `259`
