...
def test_run_contract_check_published_schema_keeps_schema_required_fields_strict() -> None:
    from grd.mcp.servers.verification_server import mcp
    from grd.mcp.verification_contract_policy import VERIFICATION_BINDING_FIELD_NAMES
...
def test_contract_binding_request_model_fields_match_canonical_binding_field_names() -> None:
    from grd.mcp.servers.verification_server import ContractBindingRequest
    from grd.mcp.verification_contract_policy import VERIFICATION_BINDING_FIELD_NAMES
...
def test_contract_payload_schema_does_not_advertise_scalar_list_drift() -> None:
    from grd.mcp.servers.verification_server import _CONTRACT_PAYLOAD_INPUT_SCHEMA
...
def test_contract_check_request_templates_use_string_artifact_placeholders() -> None:
    from grd.mcp.servers.verification_server import _CONTRACT_CHECK_REQUEST_HINTS
...
def test_contract_parse_recoverability_keeps_case_drift_nonblocking() -> None:
    from grd.mcp.servers.verification_server import _is_recoverable_contract_parse_error, run_contract_check
