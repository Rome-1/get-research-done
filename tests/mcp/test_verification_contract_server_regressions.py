...
def _project_local_contract_fixture(project_root: Path) -> dict[str, object]:
    ...
    contract["context_intake"]["must_include_prior_outputs"] = ["GRD/phases/01-setup/01-01-SUMMARY.md"]
    ...
    artifact.write_text("{}\n", encoding="utf-8")
    baseline = project_root / "GRD" / "phases" / "01-setup" / "01-01-SUMMARY.md"
...
def test_contract_check_tool_schemas_publish_optional_absolute_project_dir() -> None:
    from grd.mcp.servers import ABSOLUTE_PROJECT_DIR_SCHEMA
...
def test_contract_server_singleton_drift_classifier_matches_core_contract_policy() -> None:
    from grd.mcp.servers.verification_server import _is_defaultable_singleton_contract_error
...
def test_contract_tools_reject_unknown_nested_contract_fields() -> None:
    from grd.contracts import parse_project_contract_data_salvage
    from grd.mcp.servers.verification_server import run_contract_check, suggest_contract_checks
...
def test_contract_tools_normalize_recoverable_enum_literals(
    ...
    from grd.contracts import contract_from_data_salvage
    from grd.mcp.servers.verification_server import run_contract_check, suggest_contract_checks
...
def test_verification_server_success_responses_keep_strict_stable_envelopes() -> None:
    from grd.mcp.servers.verification_server import get_checklist, run_contract_check, suggest_contract_checks
...
def test_checklist_helpers_return_defensive_copies() -> None:
    from grd.mcp.servers.verification_server import get_bundle_checklist, get_checklist
...
def test_verification_server_pure_success_tools_return_stable_envelopes() -> None:
    ...
    from grd.mcp.servers.verification_server import (
        dimensional_check,
