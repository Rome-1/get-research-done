...
from grd.core.model_visible_text import review_contract_visibility_note
from grd.core.review_contract_prompt import render_review_contract_prompt
...
REVIEW_COMMAND_SLUGS = tuple(command_name.removeprefix("grd:") for command_name in REVIEW_COMMANDS)
