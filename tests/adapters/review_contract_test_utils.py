...
from grd.adapters.install_utils import compile_markdown_for_runtime, project_markdown_for_runtime

REPO_ROOT = Path(__file__).resolve().parents[2]
COMMANDS_DIR = REPO_ROOT / "src/grd/commands"
DEFAULT_BODY_MARKER = "Prompt body"
DEFAULT_REQUIRED_OUTPUT = "GRD/review/REFEREE-DECISION{round_suffix}.json"
DEFAULT_PROOF_OUTPUT = "GRD/review/PROOF-REDTEAM{round_suffix}.md"
...
def build_review_contract_fixture_markdown(
    *,
    command_name: str = "grd:peer-review",
