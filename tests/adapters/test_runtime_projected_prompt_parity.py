...
from grd.adapters.runtime_catalog import get_runtime_descriptor, iter_runtime_descriptors
from grd.core.model_visible_text import (
    agent_visibility_note,
    command_visibility_note,
    review_contract_visibility_note,
)
from grd.registry import _frontmatter_parts, _load_frontmatter_mapping, _parse_spawn_contracts
...
def test_runtime_projected_verifier_surface_keeps_one_wrapper_and_stays_within_budget(runtime: str) -> None:
    projected = _project_markdown(AGENTS_DIR / "grd-verifier.md", runtime, is_agent=True)
