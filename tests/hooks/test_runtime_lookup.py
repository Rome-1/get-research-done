...
from grd.hooks.install_context import resolve_hook_lookup_context
from grd.hooks.runtime_lookup import (
...
def test_resolve_hook_lookup_context_uses_shared_runtime_hint_normalizer(
    ...
    monkeypatch.setattr("grd.hooks.install_context.normalize_runtime_hint", _normalize)
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_runtime_for_grd_use", lambda **_: None)
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_active_runtime", lambda **_: None)
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_active_runtime_with_grd_install", lambda **_: None)
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_local_runtime_with_grd_install", lambda **_: None)
...
def test_resolve_hook_lookup_context_revalidates_stale_active_installed_runtime_hint(
    ...
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_runtime_for_grd_use", lambda **_: "claude-code")
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_active_runtime_with_grd_install", lambda **_: "claude-code")
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_local_runtime_with_grd_install", lambda **_: None)
...
def test_resolve_hook_lookup_context_ignores_invalid_preferred_runtime_hint(
    ...
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_active_runtime_with_grd_install", lambda **_: None)
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_local_runtime_with_grd_install", lambda **_: None)
    monkeypatch.setattr("grd.hooks.runtime_detect.detect_runtime_for_grd_use", lambda **_: "codex")
