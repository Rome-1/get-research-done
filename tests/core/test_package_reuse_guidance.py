...
TOOLING_REF = REPO_ROOT / "src" / "grd" / "specs" / "references" / "tooling" / "tool-integration.md"
RESEARCHER_SHARED = (
    REPO_ROOT / "src" / "grd" / "specs" / "references" / "research" / "researcher-shared.md"
)
PHASE_RESEARCHER = REPO_ROOT / "src" / "grd" / "agents" / "grd-phase-researcher.md"
PLANNER = REPO_ROOT / "src" / "grd" / "agents" / "grd-planner.md"
EXECUTOR = REPO_ROOT / "src" / "grd" / "agents" / "grd-executor.md"
