...
from grd.core import knowledge_docs as knowledge_docs_module
from grd.core.frontmatter import extract_frontmatter, validate_frontmatter
...
def _knowledge_content_sha256(content: str) -> str:
    ...
    for name in candidate_names:
        ...
        if isinstance(result, str) and result.strip():
            return result.strip()
    raise AssertionError("expected a knowledge-doc content sha256 helper in grd.core.knowledge_docs")
...
def _review_block(
    *,
    ...
    reviewer_id: str = "grd-reviewer",
    summary: str = "Reviewed and accepted for downstream use",
    approval_artifact_path: str | None = "GRD/knowledge/reviews/K-renormalization-group-fixed-points-R1-REVIEW.md",
