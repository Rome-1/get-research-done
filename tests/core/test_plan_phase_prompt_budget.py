...
def test_plan_phase_command_stays_thin_and_only_eagerly_loads_the_workflow() -> None:
    ...
    assert "@{GRD_INSTALL_DIR}/workflows/plan-phase.md" in command_text
    assert "@{GRD_INSTALL_DIR}/templates/plan-contract-schema.md" not in command_text
    assert "@{GRD_INSTALL_DIR}/references/ui/ui-brand.md" not in command_text
    assert "@{GRD_INSTALL_DIR}/templates/planner-subagent-prompt.md" not in command_text
