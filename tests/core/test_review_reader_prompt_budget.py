"""Prompt budget regressions for the `grd-review-reader` agent surface."""
...
def test_grd_review_reader_prompt_stays_within_expected_budget() -> None:
    metrics = measure_prompt_surface(
        AGENTS_DIR / "grd-review-reader.md",
...
def test_grd_review_reader_prompt_keeps_panel_contract_pointer_without_inlining_the_panel_schema() -> None:
