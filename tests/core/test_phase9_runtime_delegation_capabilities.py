"""Phase 9 regressions for runtime delegation capability surfacing."""

from __future__ import annotations

from grd.adapters.runtime_catalog import get_runtime_capabilities, iter_runtime_descriptors
from grd.cli import _annotate_permissions_payload
