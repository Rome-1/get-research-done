"""Prompt budget regressions for the `grd-check-proof` agent surface."""
...
def test_grd_check_proof_prompt_stays_within_expected_budget_and_drops_panel_inlining() -> None:
    path = AGENTS_DIR / "grd-check-proof.md"
