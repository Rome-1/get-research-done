...
def test_literature_review_stage_manifest_defers_reference_artifacts_and_delegation_authorities() -> None:
    ...
    assert "GRD/literature/slug-REVIEW.md" in review_handoff.writes_allowed
    assert "GRD/literature/slug-CITATION-SOURCES.json" in review_handoff.writes_allowed
...
def test_literature_review_command_prompt_budget_stays_close_to_the_workflow_surface() -> None:
    ...
    assert "@{GRD_INSTALL_DIR}/workflows/literature-review.md" in command_text
