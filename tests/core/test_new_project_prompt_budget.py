...
SETUP_QUESTION = "Which starting workflow preset should GRD use for `GRD/config.json`?"
...
def test_new_project_command_no_longer_eagerly_inlines_late_stage_authorities() -> None:
    ...
    assert "@{GRD_INSTALL_DIR}/templates/project-contract-schema.md" not in command_text
