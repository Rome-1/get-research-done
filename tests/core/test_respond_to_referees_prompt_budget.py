...
def test_respond_to_referees_command_stays_thin_and_only_eagerly_loads_the_workflow() -> None:
    ...
    assert "@{GRD_INSTALL_DIR}/workflows/respond-to-referees.md" in command_text
    ...
    assert "@{GRD_INSTALL_DIR}/references/publication/publication-review-wrapper-guidance.md" in command_text
    ...
    assert "Follow `@{GRD_INSTALL_DIR}/workflows/respond-to-referees.md` exactly." in command_text
