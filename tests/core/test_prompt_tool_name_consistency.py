...
from grd.adapters.tool_names import CANONICAL_TOOL_NAMES, build_canonical_alias_map, canonical
...
def test_new_project_notation_delegate_omits_model_argument_when_model_is_empty() -> None:
    ...
    marker = 'NOTATION_MODEL=$(grd resolve-model grd-notation-coordinator)'
    start = content.index(marker)
    task_start = content.index('task(prompt="First, read {GRD_AGENTS_DIR}/grd-notation-coordinator.md', start)
