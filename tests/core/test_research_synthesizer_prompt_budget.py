"""Prompt budget regressions for the `grd-research-synthesizer` agent surface."""
...
def test_grd_research_synthesizer_prompt_stays_within_expected_budget_and_keeps_one_shot_return_language() -> None:
    path = AGENTS_DIR / "grd-research-synthesizer.md"
    ...
    assert "This agent writes only `GRD/literature/SUMMARY.md`;" in source
