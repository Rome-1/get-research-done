"""Prompt budget regressions for the `grd-referee` agent surface."""
...
def test_grd_referee_prompt_stays_within_expected_budget() -> None:
...
def test_grd_referee_prompt_keeps_publication_path_mentions_without_eager_schema_expansion() -> None:
