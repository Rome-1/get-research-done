"""Prompt budget regressions for the `grd-bibliographer` agent surface."""
...
def test_grd_bibliographer_prompt_stays_within_expected_budget_and_keeps_contract_paths_lightweight() -> None:
    path = AGENTS_DIR / "grd-bibliographer.md"
    ...
    for ref in (
        ...
        lightweight = f"{{GRD_INSTALL_DIR}}/{ref}"
        eager = f"@{{GRD_INSTALL_DIR}}/{ref}"
