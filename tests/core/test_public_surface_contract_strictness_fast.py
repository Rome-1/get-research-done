...
import grd.core.public_surface_contract as public_surface_contract

REPO_ROOT = Path(__file__).resolve().parents[2]
CONTRACT_PATH = REPO_ROOT / "src/grd/core/public_surface_contract.json"
...
def _load_schema_payload() -> dict[str, object]:
    schema_path = REPO_ROOT / "src/grd/core/public_surface_contract_schema.json"
