"""Prompt budget regressions for the `grd-consistency-checker` surface."""
...
AGENT_PATH = REPO_ROOT / "src" / "grd" / "agents" / "grd-consistency-checker.md"
SOURCE_ROOT = REPO_ROOT / "src" / "grd"
PATH_PREFIX = "/runtime/"


def test_grd_consistency_checker_prompt_stays_small_and_keeps_its_canonical_contract() -> None:
