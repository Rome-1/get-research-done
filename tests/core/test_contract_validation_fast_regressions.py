...
from grd.contracts import ResearchContract, collect_plan_contract_integrity_errors
from grd.core.contract_validation import parse_project_contract_data_salvage, validate_project_contract
...
def test_fast_contract_validation_rootless_path_like_anchor_does_not_count_as_approved_grounding() -> None:
    ...
    contract["context_intake"]["user_asserted_anchors"] = ["GRD/phases/01-setup/01-01-SUMMARY.md"]
    ...
    assert (
        ...
        "GRD/phases/01-setup/01-01-SUMMARY.md" in validation.warnings
    )
...
def test_fast_contract_validation_accepts_existing_project_local_baseline_with_project_root(tmp_path: Path) -> None:
    ...
    contract["context_intake"]["known_good_baselines"] = ["GRD/phases/01-setup/01-01-SUMMARY.md"]

    grounded_artifact = tmp_path / "GRD" / "phases" / "01-setup" / "01-01-SUMMARY.md"
