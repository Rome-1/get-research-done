...
from grd.core.context import init_write_paper
...
def test_validate_workflow_stage_manifest_payload_loads_verify_work_manifest() -> None:
    ...
    assert manifest.stages[3].writes_allowed == ("GRD/phases/XX-name/XX-VERIFICATION.md",)
    ...
    assert manifest.stages[4].writes_allowed == ("GRD/phases/XX-name/XX-VERIFICATION.md",)
...
def test_validate_workflow_stage_manifest_payload_loads_plan_phase_manifest() -> None:
    ...
    assert "GRD/phases" in manifest.stages[2].writes_allowed
...
def test_validate_workflow_stage_manifest_payload_loads_quick_manifest() -> None:
    ...
    assert manifest.stages[1].writes_allowed == ("GRD/quick/NNN-slug/PLAN.md",)
...
def test_validate_workflow_stage_manifest_payload_loads_research_phase_manifest() -> None:
    ...
    assert manifest.stage("research_handoff").writes_allowed == ("GRD/phases/XX-name/XX-RESEARCH.md",)
