...
from grd.core.recovery_advice import RecoveryAdvice, serialize_recovery_advice
...
def test_lookup_resume_surface_helpers_prefer_canonical_values() -> None:
    ...
    assert lookup_resume_surface_text(payload, "active_resume_pointer") == "GRD/phases/07/.continue-here.md"
...
def test_resume_candidate_helpers_normalize_raw_and_canonical_shapes_to_canonical_origins() -> None:
    ...
    canonical_candidate = build_resume_candidate(
        ...
        resume_pointer="GRD/phases/03/.continue-here.md",
    )
        ...
        (
            {
                ...
                "missing_continuity_handoff_file": "GRD/phases/05/.continue-here.md",
            },
            False,
        ),
    ],
...
def test_build_resume_segment_candidate_projects_segment_fields_into_raw_resume_shape() -> None:
    ...
    assert candidate["resume_file"] == "GRD/phases/03/.continue-here.md"
...
def test_canonicalize_resume_public_payload_keeps_canonical_fields_and_strips_legacy_aliases() -> None:
    continuity_candidate = build_resume_candidate(
        {"status": "handoff", "resume_file": "GRD/phases/04/.continue-here.md"},
        kind="continuity_handoff",
        origin="continuation.handoff",
        resume_pointer="GRD/phases/04/.continue-here.md",
    )
    payload = {
        ...
        "resume_surface": {
            ...
            "session_resume_file": "GRD/phases/04/.continue-here.md",
        },
    ...
    assert canonical["active_resume_pointer"] == "GRD/phases/04/.continue-here.md"
