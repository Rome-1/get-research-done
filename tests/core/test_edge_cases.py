...
1. Empty .grd/phases/ directory but state references a phase
...
class TestEdgeMissingPhasesDir:
    """Empty .grd/phases/ dir or missing entirely while state references phases.

    Ported from the historical suite's "deep edge: missing .grd/phases/" case.
    """
