...
WORKFLOW_SPEC = Path(__file__).resolve().parents[2] / "src" / "grd" / "specs" / "workflows" / "new-project.md"
STATE_SCHEMA_SPEC = (
    Path(__file__).resolve().parents[2] / "src" / "grd" / "specs" / "templates" / "state-json-schema.md"
)
