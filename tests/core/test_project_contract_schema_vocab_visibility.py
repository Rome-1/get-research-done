...
STATE_JSON_SCHEMA = REPO_ROOT / "src/grd/specs/templates/state-json-schema.md"
...
def test_project_contract_schema_docs_surface_the_closed_contract_vocabularies() -> None:
    ...
    for schema_path in (PROJECT_CONTRACT_SCHEMA, STATE_JSON_SCHEMA):
        ...
        assert "@{GRD_INSTALL_DIR}/templates/project-contract-grounding-linkage.md" in text
