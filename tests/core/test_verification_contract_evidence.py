...
from grd.core.frontmatter import validate_frontmatter, verify_summary
...
def test_validate_frontmatter_summary_with_source_path_rejects_non_contract_plan_fragment(tmp_path: Path) -> None:
    ...
    summary_path.write_text(
        ...
        .replace(
            "plan_contract_ref: .grd/phases/01-benchmark/01-01-PLAN.md#/contract",
            "plan_contract_ref: .grd/phases/01-benchmark/01-01-PLAN.md#/not-contract",
            1,
        ),
        encoding="utf-8",
    )
...
def test_verify_summary_rejects_unresolved_plan_contract_ref(tmp_path: Path) -> None:
    ...
    summary_path.write_text(
        ...
        .replace(
            "plan_contract_ref: .grd/phases/01-benchmark/01-01-PLAN.md#/contract",
            "plan_contract_ref: .grd/phases/01-benchmark/01-02-PLAN.md#/contract",
            1,
        ),
        encoding="utf-8",
    )
...
def test_verify_summary_rejects_non_contract_plan_fragment(tmp_path: Path) -> None:
    ...
    summary_path.write_text(
        ...
        .replace(
            "plan_contract_ref: .grd/phases/01-benchmark/01-01-PLAN.md#/contract",
            "plan_contract_ref: .grd/phases/01-benchmark/01-01-PLAN.md#/summary",
            1,
        ),
        encoding="utf-8",
    )
