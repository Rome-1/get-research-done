...
from grd.core import runtime_command_surfaces as runtime_command_surfaces_module
from grd.core.runtime_command_surfaces import format_active_runtime_command, resolve_active_runtime_descriptor
...
def test_active_runtime_command_prefix_rejects_descriptor_missing_public_surface(monkeypatch) -> None:
    ...
    cli_module = importlib.import_module("grd.cli")
