...
- **Task level**: bounded execution state, active resume pointer, interrupted agents, and live review gates (older raw envelopes can still expose nested compatibility-only cues under `compat_resume_surface`)
