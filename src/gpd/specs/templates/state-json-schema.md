...
| `session` | `SessionObject` | see below | Compatibility mirror of canonical continuation for STATE.md rendering | Synced from canonical continuation / STATE.md |
