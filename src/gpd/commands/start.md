...
- `gpd resume --recent` remains the normal-terminal explicit multi-project picker
- `/gpd:resume-work` remains the in-runtime recovery command for the selected project
