...
- Creates `GPD/AUTHOR-RESPONSE{round_suffix}.md` for structured issue tracking plus `GPD/paper/REFEREE_RESPONSE{round_suffix}.md` for the journal-facing response letter
