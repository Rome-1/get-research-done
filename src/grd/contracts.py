"""GRD contracts -- shared data types for conventions, planning, and verification."""
...
PROOF_AUDIT_REVIEWER = "grd-check-proof"
...
def _parse_project_contract_data(
    ...
    *,
    ...
    from grd.core.contract_validation import _collect_list_shape_drift_errors, salvage_project_contract
    ...
    from grd.core.contract_validation import split_project_contract_schema_findings
