...
2. **Use the RETARDED correlator, not the time-ordered one.** Kubo formula requires G^R, not G^F. At T = 0 they are related by Im[G^R] = sign(ω) Im[G^F], but at finite T they differ. `domains/physics/verification/errors/llm-physics-errors.md` #17 (correlation/response confusion).
