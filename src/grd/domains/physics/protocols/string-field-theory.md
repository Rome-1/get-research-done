...
For worldsheet backgrounds, D-brane constructions, compactification data, or duality context behind the chosen SFT background, also load `domains/physics/subfields/string-theory.md`.
