...
The manuscript-root contract owns root resolution, manuscript-local artifact rooting, and `grd paper-build` authority. The round and response contracts own latest-round gating, paired response completion, and fail-closed child-return semantics.
