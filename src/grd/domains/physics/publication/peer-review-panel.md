...
- `.grd/CONSISTENCY-REPORT.md` when applicable
...
- The auxiliary `grd-check-proof` pass may run in parallel with Stages 2 and 3 when theorem-bearing claims are present.
