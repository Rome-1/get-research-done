...
**Detailed protocols:** For step-by-step calculation protocols, see `domains/physics/protocols/perturbation-theory.md` (time-dependent perturbation theory, Fermi's golden rule), `domains/physics/protocols/electrodynamics.md` (light-matter interaction, selection rules), `domains/physics/protocols/scattering-theory.md` (partial waves, Born approximation, resonances), `domains/physics/protocols/numerical-computation.md` (general numerical methods), `domains/physics/protocols/variational-methods.md` (Hartree-Fock, configuration interaction, DMRG for ultracold atoms), `domains/physics/protocols/group-theory.md` (angular momentum coupling, Wigner-Eckart theorem, selection rules), `domains/physics/protocols/wkb-semiclassical.md` (tunneling, Bohr-Sommerfeld, semiclassical dynamics), `domains/physics/protocols/green-functions.md` (retarded propagators, spectral functions, Dyson equation).
