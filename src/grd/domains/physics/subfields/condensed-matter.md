...
**Detailed protocols:** For step-by-step calculation protocols, see `domains/physics/protocols/tensor-networks.md`, `domains/physics/protocols/monte-carlo.md`, `domains/physics/protocols/density-functional-theory.md`, `domains/physics/protocols/exact-diagonalization.md`, `domains/physics/protocols/many-body-perturbation-theory.md`, `domains/physics/protocols/non-equilibrium-transport.md`, `domains/physics/protocols/analytic-continuation.md`, `domains/physics/protocols/numerical-computation.md`, `domains/physics/protocols/green-functions.md`, `domains/physics/protocols/generalized-symmetries.md`, `domains/physics/protocols/wkb-semiclassical.md`, `domains/physics/protocols/bethe-ansatz.md` (integrable 1D models), `domains/physics/protocols/random-matrix-theory.md` (spectral statistics, quantum chaos), `domains/physics/protocols/large-n-expansion.md` (1/N methods for O(N) and SU(N) models), `domains/physics/protocols/kinetic-theory.md` (Boltzmann transport).
