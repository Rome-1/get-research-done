...
**Detailed protocols:** For step-by-step calculation protocols, see `domains/physics/protocols/monte-carlo.md` (Metropolis, cluster algorithms, histogram methods), `domains/physics/protocols/order-of-limits.md` (thermodynamic limit, critical limits), `domains/physics/protocols/finite-temperature-field-theory.md` (Matsubara formalism, thermal field theory), `domains/physics/protocols/numerical-computation.md` (general numerical methods), `domains/physics/protocols/exact-diagonalization.md` (small systems, symmetry sectors), `domains/physics/protocols/stochastic-processes.md` (Langevin dynamics, master equations, FDT), `domains/physics/protocols/renormalization-group.md` (RG flows, critical exponents, universality), `domains/physics/protocols/bethe-ansatz.md` (exact solutions for integrable models), `domains/physics/protocols/large-n-expansion.md` (1/N expansion for critical exponents), `domains/physics/protocols/resummation.md` (Borel summation of asymptotic series), `domains/physics/protocols/kinetic-theory.md` (Boltzmann equation, transport coefficients).
