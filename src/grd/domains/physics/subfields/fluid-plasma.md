...
**Detailed protocols:** For step-by-step calculation protocols, see `domains/physics/protocols/fluid-dynamics-mhd.md` (regime identification, governing equations, turbulence, MHD checks), `domains/physics/protocols/numerical-computation.md` (CFD methods, convergence testing), `domains/physics/protocols/stochastic-processes.md` (turbulence models, Langevin approaches), `domains/physics/protocols/non-equilibrium-transport.md` (transport coefficients, Kubo formulae for viscosity and conductivity), `domains/physics/protocols/molecular-dynamics.md` (particle-in-cell methods, kinetic simulations), `domains/physics/protocols/order-of-limits.md` (ideal vs resistive limits, incompressible limit), `domains/physics/protocols/kinetic-theory.md` (Boltzmann equation, Chapman-Enskog, transport coefficients from first principles). For verification formulas: `domains/physics/verification/domains/verification-domain-fluid-plasma.md` (MHD equilibrium, Alfven waves, reconnection, conservation laws).
