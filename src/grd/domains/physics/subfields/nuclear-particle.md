...
**Detailed protocols:** For step-by-step calculation protocols, see `domains/physics/protocols/perturbation-theory.md` (Feynman diagram computation, loop integrals), `domains/physics/protocols/lattice-gauge-theory.md` (non-perturbative QCD, hadron spectrum), `domains/physics/protocols/effective-field-theory.md` (chiral perturbation theory, HQET, SCET), `domains/physics/protocols/phenomenology.md` (likelihoods, global fits, recasting, EFT validity), `domains/physics/protocols/scattering-theory.md` (cross sections, partial waves, resonances), `domains/physics/protocols/renormalization-group.md` (running couplings, beta functions, asymptotic freedom), `domains/physics/protocols/path-integrals.md` (functional methods, instantons, anomalies), `domains/physics/protocols/group-theory.md` (gauge symmetry, representations, Clebsch-Gordan), `domains/physics/protocols/resummation.md` (Borel summation of QCD perturbative series), `domains/physics/protocols/large-n-expansion.md` ('t Hooft limit, 1/N_c expansion), `domains/physics/protocols/random-matrix-theory.md` (nuclear level spacings, Dirac operator spectra in QCD).
...
| Frontier | Key question | GRD suitability |
|----------|-------------|-----------------|
