...
**Detailed protocols:** For step-by-step calculation protocols, see `domains/physics/protocols/perturbation-theory.md`, `domains/physics/protocols/renormalization-group.md`, `domains/physics/protocols/path-integrals.md`, `domains/physics/protocols/effective-field-theory.md`, `domains/physics/protocols/lattice-gauge-theory.md`, `domains/physics/protocols/analytic-continuation.md`, `domains/physics/protocols/finite-temperature-field-theory.md`, `domains/physics/protocols/supersymmetry.md`, `domains/physics/protocols/algebraic-qft.md`, `domains/physics/protocols/string-field-theory.md`, `domains/physics/protocols/conformal-bootstrap.md`, `domains/physics/protocols/holography-ads-cft.md`, `domains/physics/protocols/asymptotic-symmetries.md`, `domains/physics/protocols/generalized-symmetries.md`, `domains/physics/protocols/green-functions.md`, `domains/physics/protocols/wkb-semiclassical.md`, `domains/physics/protocols/resummation.md` (Borel summation, Pade, divergent series), `domains/physics/protocols/large-n-expansion.md` ('t Hooft limit, planar diagrams, matrix models).
...
| Frontier | Key question | Active groups | GRD suitability |
|----------|-------------|---------------|-----------------|
