...
|---|---|---|
| [domains/physics/verification/errors/llm-errors-core.md](domains/physics/verification/errors/llm-errors-core.md) | #1-25 | Core error classes: CG coefficients, Green's functions, group theory, asymptotics, delta functions, phase conventions, thermodynamics, field theory basics, variational bounds, partition functions |
| [domains/physics/verification/errors/llm-errors-field-theory.md](domains/physics/verification/errors/llm-errors-field-theory.md) | #26-51 | Field theory & advanced: coherent states, second quantization, angular momentum coupling, Boltzmann factors, path ordering, ensembles, numerical methods, regularization, Fierz identities, effective potentials, metric signatures, topological terms |
| [domains/physics/verification/errors/llm-errors-extended.md](domains/physics/verification/errors/llm-errors-extended.md) | #52-81, #102-104 | Extended & deep domain: numerical relativity, stellar structure, quantum chemistry, plasma physics, fluid dynamics, quantum computing, biophysics, turbulence, finite-size effects. New: catastrophic cancellation, functional Jacobians, IR safety |
| [domains/physics/verification/errors/llm-errors-deep.md](domains/physics/verification/errors/llm-errors-deep.md) | #82-101 | Cross-domain: nuclear shell model, astrophysics, AMO physics, superconductivity, magnetic reconnection, decoherence, constraints, critical phenomena, conformal mappings, Brillouin zones, Penrose diagrams, entanglement |
