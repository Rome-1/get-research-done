...
- `architecture/`: implementation-aligned architecture overviews and current design references.
...
- `verification/`: verification core, domains, evergreen coverage/prioritization references, error catalogs, and worked examples.
...
- Keep shipped reference files evergreen. Put dated audits or historical design notes outside `src/grd/specs/references/`.
