...
Referenced by `src/grd/specs/workflows/execute-plan.md`. Governs physics validation gates, deviation handling, and verification failures during plan execution.
