...
Load from state.json convention_lock via `grd convention list`:
...
plan_contract_ref: ".grd/phases/02-self-energy/02-01-PLAN.md#/contract"
contract_results:
  claims:
    claim-mass-counterterm:
      ...
      evidence:
        - verifier: grd-verifier
          ...
          evidence_path: ".grd/phases/02-self-energy/02-VERIFICATION.md"
