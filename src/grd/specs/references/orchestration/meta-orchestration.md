...
How GRD selects agents, allocates context budgets, and routes verification failures. This document covers orchestration STRATEGY, not mechanics (for mechanics, see `references/orchestration/agent-delegation.md` and `references/orchestration/agent-infrastructure.md`).
