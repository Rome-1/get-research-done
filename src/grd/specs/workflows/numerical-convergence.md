...
Called from /grd:numerical-convergence command and referenced by /grd:verify-work for numerical phases.
</purpose>
...
- File target: `.grd/analysis/numerical-{slug}.md`
