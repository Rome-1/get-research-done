...
Called from /grd:literature-review command.
</purpose>
...
Review file: .grd/literature/{slug}-REVIEW.md
...
Write results to .grd/literature/{slug}-CITATION-AUDIT.md
...
**Topic:** {topic}
**Papers reviewed:** {N}
**Report:** .grd/literature/{slug}-REVIEW.md
...
**Citation verification:** {all verified | N issues found -- see .grd/literature/{slug}-CITATION-AUDIT.md}
```
...
- [ ] Citations verified via grd-bibliographer (no hallucinated references)
