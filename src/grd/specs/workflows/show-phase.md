...
Usage: /grd:show-phase <phase-number>
```
...
```bash
grd summary-extract <path> --field one_liner --field key_results --field equations
```
...
If no verification files: "No verification performed yet. Run /grd:verify-work {phase} to validate results."
</step>
...
----------------------------------------------------------------
**Also available:**
- /grd:verify-work {N} -- run physics validation checks
- /grd:execute-phase {N} -- execute pending plans
- /grd:plan-phase {N} -- create new plans
----------------------------------------------------------------
```
