...
Called from /grd:dimensional-analysis command. Produces DIMENSIONAL-ANALYSIS.md report.
...
- File target: `.grd/analysis/dimensional-{slug}.md`
...
- `/grd:debug` -- investigate anomalies
