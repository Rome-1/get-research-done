...
Write this analysis to `.grd/DEPENDENCY-GRAPH.md`? (y/n)
...
Write the full report to `.grd/DEPENDENCY-GRAPH.md`.
...
**Also available:**
- `/grd:show-phase <N>` -- inspect a specific phase in detail
- `/grd:plan-phase <N>` -- plan an unstarted phase
- `/grd:progress` -- overall research progress
...
- [ ] Optional write to .grd/DEPENDENCY-GRAPH.md offered
