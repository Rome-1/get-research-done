<purpose>
Create presentation slides from either a GRD project or the current workspace. The workflow should identify the best source material available, clarify the talk brief, choose an appropriate slide format, and produce concrete deck files under `slides/`.
</purpose>
...
1. Detect whether this is an initialized GRD project:
   - `.grd/PROJECT.md`
   - `.grd/ROADMAP.md`
   - `.grd/STATE.md`
...
Do not modify `.grd/STATE.md`, `.grd/ROADMAP.md`, `.grd/PROJECT.md`, or any project state files as part of this workflow.
...
- `{GRD_INSTALL_DIR}/templates/slides/presentation-brief.md`
- `{GRD_INSTALL_DIR}/templates/slides/outline.md`
- `{GRD_INSTALL_DIR}/templates/slides/slides.md`
- `{GRD_INSTALL_DIR}/templates/slides/speaker-notes.md`
- `{GRD_INSTALL_DIR}/templates/slides/main.tex`
</step>
