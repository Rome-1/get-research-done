...
```bash
cat .grd/ROADMAP.md | grep -i "Phase ${PHASE}"
```
...
```
What's next?
1. Discuss methodology (/grd:discuss-phase ${PHASE}) - Socratic dialogue to make methodological decisions
2. Plan this phase (/grd:plan-phase ${PHASE}) - Create detailed research execution plans
