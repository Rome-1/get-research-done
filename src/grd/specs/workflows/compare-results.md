...
- {GRD_INSTALL_DIR}/templates/paper/internal-comparison.md -- Template for decisive internal comparisons and verdict ledgers
</required_reading>
...
Write `.grd/comparisons/[slug]-COMPARISON.md` using the internal-comparison template.
