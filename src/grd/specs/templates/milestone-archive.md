...
This template is used by the complete-milestone workflow to create archive files in `.grd/milestones/`.
...
_For current project status, see .grd/ROADMAP.md_
...
- Save to `.grd/milestones/{milestone-name}.md`
- Example: `.grd/milestones/paper-i-submitted.md`
