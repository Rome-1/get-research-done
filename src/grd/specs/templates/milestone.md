...
<!-- For the detailed archive format used by /grd:complete-milestone, see milestone-archive.md -->

# Milestone Entry Template

Add this entry to `.grd/MILESTONES.md` when completing a research milestone:
