...
<!-- Used by: grd-paper-writer and write-paper workflow. -->

# LaTeX Preamble Template

Template for `.grd/analysis/LATEX_PREAMBLE.md` - standard LaTeX preamble and macros for the research project.
