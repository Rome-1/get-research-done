...
Template for `.grd/CONVENTIONS.md` — persistent, append-only record of all physics conventions adopted across the project lifetime.
...
- `research-map/CONVENTIONS.md` is an analysis snapshot produced by `/grd:map-research` — it documents what conventions ARE in existing work
