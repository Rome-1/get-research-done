...
<!-- Used by: grd-executor during multi-step derivations. Reference from execute-plan workflow. -->

# Calculation Log Template

Template for `.grd/phases/XX-name/CALCULATION_LOG.md` - detailed record of derivations and computations within a phase.
