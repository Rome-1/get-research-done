...
> outputs in `.grd/research-map/` (`FORMALISM.md`, `ARCHITECTURE.md`, `CONVENTIONS.md`,
...
Template for `.grd/research/METHODS.md` - recommended methods and computational tools for the research domain.
