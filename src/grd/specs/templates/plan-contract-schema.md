...
context_intake:
  ...
  user_asserted_anchors: ["GRD/phases/00-baseline/00-01-SUMMARY.md#lattice-normalization"]
  known_good_baselines: ["GRD/phases/00-baseline/00-01-SUMMARY.md#published-large-n-curve"]
...
```bash
grd frontmatter validate .grd/phases/XX-name/XX-YY-PLAN.md --schema plan
grd validate plan-contract .grd/phases/XX-name/XX-YY-PLAN.md
```
