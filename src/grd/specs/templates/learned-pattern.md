...
Concrete, actionable checks that the verifier can perform. Reference specific verification patterns from `@get-research-done/references/verification/core/verification-core.md` (or the relevant domain file) where applicable.
