...
Template for `.grd/phases/XX-name/{phase}-CONTEXT.md` - captures research decisions for a phase.
...
- `grd-phase-researcher` — Reads decisions to focus literature review (e.g., "dimensional regularization" -> research dim-reg techniques for this class of integrals)
- `grd-planner` — Reads decisions to create specific tasks (e.g., "Wolff cluster algorithm" -> task includes cluster update implementation)
...
- File lives in phase directory: `.grd/phases/XX-name/{phase}-CONTEXT.md`
- `grd-phase-researcher` uses decisions to focus literature investigation
