...
Template for `paper/reproducibility-manifest.json` — the machine-readable manifest consumed by `grd validate reproducibility-manifest` and strict review preflight checks.
...
**Strict review-ready requirements (`grd validate reproducibility-manifest ... --strict` and strict review preflight):**
...
- Validate with `grd validate reproducibility-manifest paper/reproducibility-manifest.json --strict`
