...
Canonical source of truth for `${PAPER_DIR}/BIBLIOGRAPHY-AUDIT.json`, the machine-readable bibliography audit emitted by `grd paper-build`.
...
- Regenerate this file with `grd paper-build` after bibliography changes instead of editing counts manually.
