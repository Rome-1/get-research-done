...
Template for `.grd/paper/FIGURE_TRACKER.md` — registry of all figures for the manuscript with source data, dependencies, and status.
...
figure_registry:
  - id: fig-curvature-flow-bounds
    ...
    comparison_sources:
      - .grd/comparisons/main-benchmark-COMPARISON.md
---
