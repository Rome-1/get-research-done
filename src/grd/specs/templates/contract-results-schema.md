...
```yaml
plan_contract_ref: .grd/phases/XX-name/XX-YY-PLAN.md#/contract
```

Rules:

- Must be a string.
- Must be the canonical project-root-relative `.grd/phases/XX-name/XX-YY-PLAN.md#/contract` path, not an absolute path, URL, or parent-traversing path.
  ...
  claims:
    claim-main:
      ...
      proof_audit:
        ...
        audit_artifact_path: GRD/phases/01-proof/01-01-PROOF-REDTEAM.md
...
```bash
grd frontmatter validate .grd/phases/XX-name/XX-YY-SUMMARY.md --schema summary
grd validate summary-contract .grd/phases/XX-name/XX-YY-SUMMARY.md
grd frontmatter validate .grd/phases/XX-name/XX-VERIFICATION.md --schema verification
grd validate verification-contract .grd/phases/XX-name/XX-VERIFICATION.md
```
