...
Template for `.grd/phases/XX-name/{phase}-RESEARCH.md` - comprehensive literature and methods research before planning a physics research phase.
...
> methods, use the split `map-research` outputs in `.grd/research-map/` (`FORMALISM.md`,
...
- File lives in phase directory: `.grd/phases/XX-name/{phase}-RESEARCH.md`
