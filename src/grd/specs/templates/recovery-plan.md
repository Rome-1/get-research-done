...
Template for `.grd/phases/XX-name/{phase}-{plan}-RECOVERY.md` - structured recovery after a plan execution failure.
...
Run `/grd:revise-phase` to create a replacement plan that:
