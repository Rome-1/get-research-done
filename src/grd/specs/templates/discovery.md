...
Template for `.grd/phases/XX-name/DISCOVERY.md` - pre-planning discovery of physics landscape, methods, and known results.
...
- DISCOVERY.md lives in phase directory: `.grd/phases/XX-name/DISCOVERY.md`
