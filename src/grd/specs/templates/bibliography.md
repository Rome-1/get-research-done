...
Template for `.grd/BIBLIOGRAPHY.md` -- optional reference and anchor ledger for projects that want a
human-readable registry alongside the live BibTeX files and the structured project contract.

**Status:** Not wired into the current GRD bibliography flow. The live bibliographer/paper pipeline
...
- `references/references.bib` is the BibTeX file maintained by the grd-bibliographer agent
...
- **Verified**: Checked by grd-bibliographer against INSPIRE/ADS/Google Scholar
...
**Reading:** By grd-bibliographer agent
...
**Reading:** By grd-paper-writer agent
...
The grd-bibliographer agent checks each entry:
