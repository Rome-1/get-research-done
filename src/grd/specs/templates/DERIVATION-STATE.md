...
Template for `.grd/DERIVATION-STATE.md` — cumulative record of equations, conventions, and intermediate results across all sessions.
...
5. **Git preserves history.** Pruned content is recoverable via `git log -p -- .grd/DERIVATION-STATE.md`.
```
