...
Template for `.grd/analysis/UNCERTAINTY-BUDGET.md` -- tracks all numerical quantities, their uncertainties, and how uncertainties propagate through multi-step calculations.
...
- The `/grd:error-propagation` workflow automates tracking across phases
- The `/grd:sensitivity-analysis` workflow identifies which parameters matter most
