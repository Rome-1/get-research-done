...
See `domains/physics/verification/domains/verification-domain-string-field-theory.md` for string-field-theory-specific checks and `domains/physics/verification/core/verification-core.md` for universal physics checks.
