...
See `domains/physics/verification/core/verification-core.md` for universal checks and `domains/physics/verification/domains/verification-domain-qft.md` for QFT-specific verification when the mathematical physics problem involves quantum field theory structures.
