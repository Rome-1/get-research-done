...
See `domains/physics/verification/core/verification-core.md` for universal checks and `domains/physics/verification/domains/verification-domain-statmech.md` for stat mech-specific verification (detailed balance, finite-size scaling, thermodynamic consistency).
