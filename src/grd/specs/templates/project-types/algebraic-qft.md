...
See `domains/physics/verification/domains/verification-domain-algebraic-qft.md` for AQFT-specific checks and `domains/physics/verification/core/verification-core.md` for universal checks.
