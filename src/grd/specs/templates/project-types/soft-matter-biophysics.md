...
See `domains/physics/verification/core/verification-core.md` for universal checks, `domains/physics/verification/domains/verification-domain-soft-matter.md` for soft-matter-specific verification (equilibration, scaling laws, force field validation, finite-size analysis, active matter checks), and `domains/physics/verification/domains/verification-domain-statmech.md` for statistical mechanics checks (detailed balance, thermodynamic consistency, finite-size scaling).
