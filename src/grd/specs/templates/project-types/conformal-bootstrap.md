...
See `domains/physics/verification/domains/verification-domain-mathematical-physics.md` for CFT/bootstrap verification and `domains/physics/verification/core/verification-core.md` for universal checks.
