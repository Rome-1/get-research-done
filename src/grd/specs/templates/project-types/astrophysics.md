...
See `domains/physics/verification/core/verification-core.md` for universal checks and `domains/physics/verification/domains/verification-domain-astrophysics.md` for astrophysics-specific verification (hydrostatic equilibrium, Eddington luminosity, Jeans mass, nuclear burning, accretion physics, gravitational wave sources).
