...
See `domains/physics/verification/core/verification-core.md` for universal checks (dimensional analysis, limiting cases, conservation laws, order-of-magnitude) and `domains/physics/verification/core/verification-numerical.md` for numerical verification (energy conservation in symplectic integrators, convergence testing, Lyapunov exponent validation).
