...
See `domains/physics/verification/core/verification-core.md` for universal checks and `domains/physics/verification/domains/verification-domain-quantum-info.md` for quantum-information-specific verification (CPTP, entanglement measures, channel capacity, error correction, circuit correctness).
