...
Template for `.grd/DECISIONS.md` — append-only log of research decisions across all phases.
...
- Survives context resets (lives in .grd/, committed to git)
...
**Reading:** On demand via `/grd:decisions`
