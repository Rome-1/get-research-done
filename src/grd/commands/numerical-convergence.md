---
name: grd:numerical-convergence
...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/numerical-convergence.md
</execution_context>
...
- Phase target: `.grd/phases/XX-name/CONVERGENCE.md`
- File target: `.grd/analysis/convergence-{slug}.md`
