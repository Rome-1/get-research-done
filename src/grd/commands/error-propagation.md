...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/error-propagation.md
</execution_context>
...
<process>
Execute the error-propagation workflow from @{GRD_INSTALL_DIR}/workflows/error-propagation.md end-to-end.
...
Save to:
- Phase target: `.grd/phases/XX-name/ERROR-BUDGET.md`
- Project-wide: `.grd/analysis/error-budget-{target}.md`
