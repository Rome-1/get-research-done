...
12. **Verify references** — Spawn grd-bibliographer to verify all citations against INSPIRE/ADS/arXiv, detect orphans, check formatting
13. **Pre-submission review** — Run the same staged peer-review panel used by `/grd:peer-review`
...
For a standalone rerun of the referee stage after the manuscript already exists, use `/grd:peer-review`.
</process>
...
- [ ] All sections drafted by grd-paper-writer agents (Results first, Abstract last)
...
- [ ] Pre-submission staged peer review completed with final grd-referee adjudication
