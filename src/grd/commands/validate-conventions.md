...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/validate-conventions.md
</execution_context>
...
<process>
Execute the validate-conventions workflow from @{GRD_INSTALL_DIR}/workflows/validate-conventions.md end-to-end.
