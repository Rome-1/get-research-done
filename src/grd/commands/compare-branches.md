...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/compare-branches.md
</execution_context>
...
<process>
Execute the compare-branches workflow from @{GRD_INSTALL_DIR}/workflows/compare-branches.md end-to-end.
