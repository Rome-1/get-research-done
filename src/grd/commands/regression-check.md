...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/regression-check.md
</execution_context>
...
- Local `grd regression-check --quick` additionally limits the scan to the two most recent completed phases
...
<process>
Execute the regression-check workflow from @{GRD_INSTALL_DIR}/workflows/regression-check.md end-to-end.
