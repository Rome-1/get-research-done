...
requires:
  files: [".grd/v*-MILESTONE-AUDIT.md"]
allowed-tools:
  - file_read
  - file_write
  - shell
...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/plan-milestone-gaps.md
</execution_context>

<context>
**Audit results:**
find_files: .grd/v*-MILESTONE-AUDIT.md (use most recent)
...
<process>
Execute the plan-milestone-gaps workflow from @{GRD_INSTALL_DIR}/workflows/plan-milestone-gaps.md end-to-end.
