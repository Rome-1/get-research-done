...
description: Switch research profile for GRD agents (deep-theory/numerical/exploratory/review/paper-writing)
...
<objective>
Switch the research profile used by GRD agents. Controls how each agent approaches physics tasks, balancing rigor and depth vs speed and breadth.
...
- Reminder that `/grd:settings` handles concrete runtime model IDs per tier
  </objective>

<execution_context>
@{GRD_INSTALL_DIR}/workflows/set-profile.md
</execution_context>

<process>
**Follow the set-profile workflow** from `@{GRD_INSTALL_DIR}/workflows/set-profile.md`.
