...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/revise-phase.md
</execution_context>
...
Execute the revise-phase workflow from @{GRD_INSTALL_DIR}/workflows/revise-phase.md end-to-end.
