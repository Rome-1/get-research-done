...
<objective>
Record a project-specific learning, error pattern, or insight to `.grd/INSIGHTS.md`.
...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/record-insight.md
</execution_context>
...
<process>
**Follow the record-insight workflow** from `@{GRD_INSTALL_DIR}/workflows/record-insight.md`.

The workflow handles all logic including:

1. Checking/creating `.grd/INSIGHTS.md`
