...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/audit-milestone.md
</execution_context>
...
**Planned Work:**
@.grd/ROADMAP.md
@.grd/config.json (if exists)

**Completed Work:**
find_files: .grd/phases/*/*SUMMARY.md
find_files: .grd/phases/*/*-VERIFICATION.md
</context>
...
<process>
Execute the audit-milestone workflow from @{GRD_INSTALL_DIR}/workflows/audit-milestone.md end-to-end.
