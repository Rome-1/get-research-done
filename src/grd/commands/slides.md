---
name: grd:slides
description: Create presentation slides from a GRD project or the current folder
...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/slides.md
</execution_context>
...
If a GRD project exists, use it:
...
Follow the slides workflow from `@{GRD_INSTALL_DIR}/workflows/slides.md` end-to-end.
