...
<execution_context>
@{GRD_INSTALL_DIR}/workflows/graph.md
</execution_context>
...
<process>
Execute the graph workflow from @{GRD_INSTALL_DIR}/workflows/graph.md end-to-end.
...
Offer to write the graph and analysis to `.grd/DEPENDENCY-GRAPH.md`.
</process>
