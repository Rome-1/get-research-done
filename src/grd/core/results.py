"""Intermediate result tracking for GRD research state.
...
from grd.core.utils import phase_normalize, phase_unpad
...
class IntermediateResult(BaseModel):
    """A single intermediate result tracked in the GRD state."""
...
@instrument_grd_function("results.add")
def result_add(
    state: dict,
    *,
    equation: str | None = None,
...
@instrument_grd_function("results.search")
def result_search(
    state: dict,
    *,
    id: str | None = None,
...
@instrument_grd_function("results.upsert")
def result_upsert(
    state: dict,
    *,
    equation: str | None = None,
...
@instrument_grd_function("results.upsert_derived")
...
@instrument_grd_function("results.deps")
...
@instrument_grd_function("results.update")
def result_update(
    state: dict,
    result_id: str,
