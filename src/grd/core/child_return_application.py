...
This module turns a validated ``grd_return`` envelope into durable project
...
from grd.core.return_contract import GpdReturnContinuationUpdate, GpdReturnEnvelope
