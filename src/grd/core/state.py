"""Dual-write state management for GRD research projects.
...
from grd.core.errors import StateError
from grd.core.extras import Approximation
from grd.core.extras import Uncertainty as PropagatedUncertainty
...
from grd.core.conventions import CONVENTION_LABELS as _CONVENTION_LABELS  # noqa: E402
...
@instrument_grd_function("state.sync")
...
@instrument_grd_function("state.load_json")
...
@instrument_grd_function("state.save")
def save_state_json(
    cwd: Path,
    state_obj: dict,
    *,
...
@instrument_grd_function("state.save_markdown")
...
@instrument_grd_function("state.load")
...
@instrument_grd_function("state.get")
...
@instrument_grd_function("state.update")
...
@instrument_grd_function("state.patch")
...
@instrument_grd_function("state.set_project_contract")
...
@instrument_grd_function("state.set_continuation_bounded_segment")
...
@instrument_grd_function("state.carry_forward_continuation_last_result_id")
...
@instrument_grd_function("state.clear_continuation_bounded_segment")
...
@instrument_grd_function("state.advance_plan")
...
@instrument_grd_function("state.record_metric")
...
@instrument_grd_function("state.update_progress")
...
@instrument_grd_function("state.add_decision")
...
@instrument_grd_function("state.add_blocker")
...
@instrument_grd_function("state.resolve_blocker")
...
@instrument_grd_function("state.record_session")
...
@instrument_grd_function("state.snapshot")
...
@instrument_grd_function("state.validate")
def state_validate(
    cwd: Path,
    integrity_mode: str = "standard",
    *,
...
@instrument_grd_function("state.compact")
