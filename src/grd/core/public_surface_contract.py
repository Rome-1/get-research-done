...
_LOCAL_CLI_INSTALL_LOCAL_EXAMPLE_COMMAND = "grd install <runtime> --local"
_LOCAL_CLI_DOCTOR_LOCAL_COMMAND = "grd doctor --runtime <runtime> --local"
_LOCAL_CLI_DOCTOR_GLOBAL_COMMAND = "grd doctor --runtime <runtime> --global"
_LOCAL_CLI_VALIDATE_COMMAND_CONTEXT_COMMAND = "grd validate command-context grd:<name>"
...
def load_public_surface_contract_schema() -> PublicSurfaceContractSchema:
    ...
    schema_path = files("grd.core").joinpath("public_surface_contract_schema.json")
...
def load_public_surface_contract() -> PublicSurfaceContract:
    ...
    contract_path = files("grd.core").joinpath("public_surface_contract.json")
