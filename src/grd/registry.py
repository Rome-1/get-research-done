"""GRD content registry — canonical source for commands and agents.

Primary GRD commands and agents live in markdown files with YAML frontmatter.
...
# registry → adapters.install_utils → adapters → adapters.base → registry
# Deferred to _inline_model_visible_includes() call site.
from grd.command_labels import canonical_command_label, canonical_skill_label, command_slug_from_label
from grd.core.model_visible_sections import render_model_visible_yaml_section
...
from grd.core.workflow_staging import (
...
_PKG_ROOT = Path(__file__).resolve().parent  # grd/
AGENTS_DIR = _PKG_ROOT / "agents"
COMMANDS_DIR = _PKG_ROOT / "commands"
_MODEL_VISIBLE_INCLUDE_PATH_PREFIX = "{GRD_INSTALL_DIR}/__grd_registry_include__/"
...
def _inline_model_visible_includes(content: str) -> str:
    ...
    from grd.adapters.install_utils import expand_at_includes  # noqa: PLC0415 — lazy to avoid circular import
...
class _RegistryCache:
    """Lazy-loaded, process-lifetime cache of all GRD content."""
...
_SKILL_CATEGORY_MAP: dict[str, str] = {
    "grd-execute": "execution",
    "grd-plan-checker": "verification",
    "grd-plan": "planning",
    "grd-verify": "verification",
    "grd-debug": "debugging",
    "grd-new": "project",
    "grd-write": "paper",
    "grd-peer-review": "paper",
    "grd-review": "paper",
    "grd-paper": "paper",
    "grd-literature": "research",
    "grd-research": "research",
    "grd-discover": "research",
    "grd-explain": "help",
    "grd-start": "help",
    "grd-tour": "help",
    "grd-map": "exploration",
    "grd-show": "exploration",
    "grd-progress": "status",
    "grd-health": "diagnostics",
    "grd-validate": "verification",
    "grd-check": "verification",
    "grd-audit": "verification",
    "grd-add": "management",
    "grd-insert": "management",
    "grd-remove": "management",
    "grd-merge": "management",
    "grd-complete": "management",
    "grd-compact": "management",
    "grd-pause": "session",
    "grd-resume": "session",
    "grd-record": "management",
    "grd-export": "output",
    "grd-arxiv": "output",
    "grd-graph": "visualization",
    "grd-decisions": "status",
    "grd-error-propagation": "analysis",
    "grd-error": "diagnostics",
    "grd-sensitivity": "analysis",
    "grd-numerical": "analysis",
    "grd-dimensional": "analysis",
    "grd-limiting": "analysis",
    "grd-parameter": "analysis",
    "grd-compare": "analysis",
    "grd-derive": "computation",
    "grd-set": "configuration",
    "grd-update": "management",
    "grd-undo": "management",
    "grd-sync": "management",
    "grd-branch": "management",
    "grd-respond": "paper",
    "grd-reapply": "management",
    "grd-regression": "verification",
    "grd-quick": "execution",
    "grd-help": "help",
    "grd-suggest": "help",
    # Full-name entries for skills not captured by prefix matching.
    "grd-bibliographer": "research",
    "grd-check-todos": "management",
    "grd-consistency-checker": "verification",
    "grd-discuss-phase": "planning",
    "grd-executor": "execution",
    "grd-experiment-designer": "planning",
    "grd-explainer": "help",
    "grd-list-phase-assumptions": "planning",
    "grd-notation-coordinator": "verification",
    "grd-phase-researcher": "research",
    "grd-project-researcher": "research",
    "grd-referee": "paper",
    "grd-revise-phase": "management",
    "grd-roadmapper": "planning",
    "grd-slides": "output",
    "grd-research-mapper": "exploration",
    "grd-verifier": "verification",
}
...
def _infer_skill_category(skill_name: str) -> str:
    ...
    ``grd-check-todos``) take priority over shorter prefixes (e.g.
    ``grd-check``).
    """
...
def _canonical_skill_name_for_command(registry_name: str, command: CommandDef) -> str:
    """Project a command registry entry into the canonical grd-* skill namespace."""
    if command.name.startswith("grd:"):
        return command.name.replace("grd:", "grd-", 1)
    if registry_name.startswith("grd-"):
        return registry_name
    return f"grd-{registry_name}"
