...
from grd.mcp.paper.artifact_manifest import build_artifact_manifest, write_artifact_manifest
...
from grd.mcp.paper.figures import _prepare_figures_with_sources
from grd.mcp.paper.journal_map import get_journal_spec
from grd.mcp.paper.models import FigureRef, JournalSpec, PaperConfig, PaperOutput
