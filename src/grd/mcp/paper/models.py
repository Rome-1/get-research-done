...
from grd.contracts import statement_looks_theorem_like
...
def normalize_acknowledgments(value: str) -> str:
    """Ensure the required GRD acknowledgment is always present exactly once."""
...
class PaperConfig(BaseModel):
    ...
    attribution_footer: str = "Generated with Get Research Done"
