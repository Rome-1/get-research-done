...
WOLFRAM_MANAGED_SERVER_KEY = "grd-wolfram"
WOLFRAM_BRIDGE_COMMAND = "grd-mcp-wolfram"
...
def _project_integrations_config_path(cwd: Path) -> Path:
    ...
    return ProjectLayout(project_root or workspace_cwd).grd / INTEGRATIONS_CONFIG_FILENAME
